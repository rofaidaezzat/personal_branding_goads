...
import { Stethoscope, Scale, Lightbulb, Briefcase, Laptop } from 'lucide-react';
export const Audience = () => {
  const audiences = [{
    ...
    title: 'أصحاب البيزنس والخدمات',
    icon: <Briefcase />,
    desc: 'لو عندك شركة أو خدمة، وجودك الشخصي كصاحب البيزنس بيزود الثقة في البراند نفسه.',
    examples: 'شركات تسويق، شركات عقارات، مراكز تدريب، عيادات، مكاتب خدمات.',
    image: 'https://images.unsplash.com/photo-1556761175-4b46a572b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80'
  }, {
    title: 'الفريلانسرز والخبراء',
    icon: <Laptop />,
    desc: 'لو أنت شاطر في مجالك بس مش عارف تظهر أو تجيب عملاء، البراند الشخصي بيساعدك تبني صورة أقوى وتبيع بسعر أعلى.',
    examples: 'Designers، marketers، consultants، photographers، developers.',
  ...
  return <section id="audience" className="py-24 bg-white">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {audiences.map((item, index) => <motion.div key={index} initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
